...
-- to UUID v7 primary keys while keeping catalog/configuration table ids numeric.
-- PostgreSQL uses a session-local helper only to backfill existing rows during
-- this migration. New ids must be generated by the backend before insert.
...
CREATE FUNCTION pg_temp.uuid_v7()
RETURNS UUID
LANGUAGE plpgsql
VOLATILE
AS $$
...
BEGIN
    ...
    uuid_hex := encode(uuid_bytes, 'hex');
...
UPDATE users SET id_uuid = pg_temp.uuid_v7();
UPDATE addresses SET id_uuid = pg_temp.uuid_v7();
UPDATE restaurants SET id_uuid = pg_temp.uuid_v7();
UPDATE products SET id_uuid = pg_temp.uuid_v7();
UPDATE orders SET id_uuid = pg_temp.uuid_v7();
UPDATE order_items SET id_uuid = pg_temp.uuid_v7();
UPDATE delivery_assignments SET id_uuid = pg_temp.uuid_v7();
UPDATE payments SET id_uuid = pg_temp.uuid_v7();
UPDATE reviews SET id_uuid = pg_temp.uuid_v7();
UPDATE complaints SET id_uuid = pg_temp.uuid_v7();
UPDATE carts SET id_uuid = pg_temp.uuid_v7();
UPDATE cart_items SET id_uuid = pg_temp.uuid_v7();
UPDATE order_status_history SET id_uuid = pg_temp.uuid_v7();
UPDATE delivery_batches SET id_uuid = pg_temp.uuid_v7();
UPDATE delivery_batch_orders SET id_uuid = pg_temp.uuid_v7();
UPDATE delivery_locations SET id_uuid = pg_temp.uuid_v7();
UPDATE refunds SET id_uuid = pg_temp.uuid_v7();
UPDATE invoices SET id_uuid = pg_temp.uuid_v7();
UPDATE coupon_redemptions SET id_uuid = pg_temp.uuid_v7();
UPDATE loyalty_accounts SET id_uuid = pg_temp.uuid_v7();
UPDATE loyalty_transactions SET id_uuid = pg_temp.uuid_v7();
