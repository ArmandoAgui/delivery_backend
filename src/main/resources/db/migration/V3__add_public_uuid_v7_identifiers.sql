-- Converts BIGSERIAL/BIGINT primary and foreign keys to UUIDv7.
-- PostgreSQL 15 does not include UUIDv7 natively, so this migration defines
-- a small database-side UUIDv7 generator for defaults and data backfill.
...
-- ============================================================================
-- Drop indexes and constraints that depend on numeric identifiers.
-- ============================================================================
...
ALTER TABLE orders DROP CONSTRAINT IF EXISTS fk_orders_coupon_id_coupons;

ALTER TABLE restaurant_commissions DROP CONSTRAINT IF EXISTS fk_restaurant_commissions_restaurant_id_restaurants;
ALTER TABLE loyalty_transactions DROP CONSTRAINT IF EXISTS fk_loyalty_transactions_order_id_orders;
ALTER TABLE loyalty_transactions DROP CONSTRAINT IF EXISTS fk_loyalty_transactions_loyalty_account_id_loyalty_accounts;
ALTER TABLE loyalty_accounts DROP CONSTRAINT IF EXISTS fk_loyalty_accounts_customer_user_id_users;
ALTER TABLE coupon_redemptions DROP CONSTRAINT IF EXISTS fk_coupon_redemptions_customer_user_id_users;
ALTER TABLE coupon_redemptions DROP CONSTRAINT IF EXISTS fk_coupon_redemptions_order_id_orders;
ALTER TABLE coupon_redemptions DROP CONSTRAINT IF EXISTS fk_coupon_redemptions_coupon_id_coupons;
ALTER TABLE invoices DROP CONSTRAINT IF EXISTS fk_invoices_payment_id_payments;
ALTER TABLE invoices DROP CONSTRAINT IF EXISTS fk_invoices_order_id_orders;
ALTER TABLE refunds DROP CONSTRAINT IF EXISTS fk_refunds_complaint_id_complaints;
ALTER TABLE refunds DROP CONSTRAINT IF EXISTS fk_refunds_payment_id_payments;
ALTER TABLE delivery_locations DROP CONSTRAINT IF EXISTS fk_delivery_locations_delivery_batch_id_delivery_batches;
ALTER TABLE delivery_locations DROP CONSTRAINT IF EXISTS fk_delivery_locations_order_id_orders;
ALTER TABLE delivery_locations DROP CONSTRAINT IF EXISTS fk_delivery_locations_delivery_user_id_users;
ALTER TABLE delivery_batch_orders DROP CONSTRAINT IF EXISTS fk_delivery_batch_orders_order_id_orders;
ALTER TABLE delivery_batch_orders DROP CONSTRAINT IF EXISTS fk_delivery_batch_orders_delivery_batch_id_delivery_batches;
ALTER TABLE delivery_batches DROP CONSTRAINT IF EXISTS fk_delivery_batches_delivery_user_id_users;
ALTER TABLE order_status_history DROP CONSTRAINT IF EXISTS fk_order_status_history_changed_by_user_id_users;
ALTER TABLE order_status_history DROP CONSTRAINT IF EXISTS fk_order_status_history_order_id_orders;
ALTER TABLE cart_items DROP CONSTRAINT IF EXISTS fk_cart_items_product_id_products;
ALTER TABLE cart_items DROP CONSTRAINT IF EXISTS fk_cart_items_cart_id_carts;
ALTER TABLE carts DROP CONSTRAINT IF EXISTS fk_carts_restaurant_id_restaurants;
ALTER TABLE carts DROP CONSTRAINT IF EXISTS fk_carts_customer_user_id_users;
ALTER TABLE restaurant_schedules DROP CONSTRAINT IF EXISTS fk_restaurant_schedules_restaurant_id_restaurants;
ALTER TABLE complaints DROP CONSTRAINT IF EXISTS fk_complaints_assigned_admin_user_id_users;
ALTER TABLE complaints DROP CONSTRAINT IF EXISTS fk_complaints_customer_user_id_users;
ALTER TABLE complaints DROP CONSTRAINT IF EXISTS fk_complaints_order_id_orders;
ALTER TABLE reviews DROP CONSTRAINT IF EXISTS fk_reviews_delivery_user_id_users;
ALTER TABLE reviews DROP CONSTRAINT IF EXISTS fk_reviews_restaurant_id_restaurants;
ALTER TABLE reviews DROP CONSTRAINT IF EXISTS fk_reviews_reviewer_user_id_users;
ALTER TABLE reviews DROP CONSTRAINT IF EXISTS fk_reviews_order_id_orders;
ALTER TABLE payments DROP CONSTRAINT IF EXISTS fk_payments_order_id_orders;
ALTER TABLE delivery_assignments DROP CONSTRAINT IF EXISTS fk_delivery_assignments_delivery_user_id_users;
ALTER TABLE delivery_assignments DROP CONSTRAINT IF EXISTS fk_delivery_assignments_order_id_orders;
ALTER TABLE order_items DROP CONSTRAINT IF EXISTS fk_order_items_product_id_products;
ALTER TABLE order_items DROP CONSTRAINT IF EXISTS fk_order_items_order_id_orders;
ALTER TABLE orders DROP CONSTRAINT IF EXISTS fk_orders_delivery_address_id_addresses;
ALTER TABLE orders DROP CONSTRAINT IF EXISTS fk_orders_restaurant_id_restaurants;
ALTER TABLE orders DROP CONSTRAINT IF EXISTS fk_orders_customer_user_id_users;
ALTER TABLE products DROP CONSTRAINT IF EXISTS fk_products_category_id_restaurant_id_categories;
ALTER TABLE products DROP CONSTRAINT IF EXISTS fk_products_restaurant_id_restaurants;
ALTER TABLE categories DROP CONSTRAINT IF EXISTS fk_categories_restaurant_id_restaurants;
ALTER TABLE restaurants DROP CONSTRAINT IF EXISTS fk_restaurants_owner_user_id_users;
ALTER TABLE addresses DROP CONSTRAINT IF EXISTS fk_addresses_user_id_users;
ALTER TABLE users DROP CONSTRAINT IF EXISTS fk_users_role_id_roles;

ALTER TABLE restaurants DROP CONSTRAINT IF EXISTS uk_restaurants_owner_user_id;
ALTER TABLE categories DROP CONSTRAINT IF EXISTS uk_categories_restaurant_id_name;
ALTER TABLE categories DROP CONSTRAINT IF EXISTS uk_categories_id_restaurant_id;
ALTER TABLE products DROP CONSTRAINT IF EXISTS uk_products_restaurant_id_name;
ALTER TABLE order_items DROP CONSTRAINT IF EXISTS uk_order_items_order_id_product_id;
ALTER TABLE delivery_assignments DROP CONSTRAINT IF EXISTS uk_delivery_assignments_order_id;
ALTER TABLE reviews DROP CONSTRAINT IF EXISTS uk_reviews_order_id_reviewer_user_id;
ALTER TABLE restaurant_schedules DROP CONSTRAINT IF EXISTS uk_restaurant_schedules_restaurant_id_day_of_week;
ALTER TABLE cart_items DROP CONSTRAINT IF EXISTS uk_cart_items_cart_id_product_id;
ALTER TABLE delivery_batch_orders DROP CONSTRAINT IF EXISTS uk_delivery_batch_orders_order_id;
ALTER TABLE delivery_batch_orders DROP CONSTRAINT IF EXISTS uk_delivery_batch_orders_batch_id_sequence;
ALTER TABLE invoices DROP CONSTRAINT IF EXISTS uk_invoices_order_id;
ALTER TABLE coupon_redemptions DROP CONSTRAINT IF EXISTS uk_coupon_redemptions_coupon_id_order_id;
ALTER TABLE loyalty_accounts DROP CONSTRAINT IF EXISTS uk_loyalty_accounts_customer_user_id;

ALTER TABLE restaurant_commissions DROP CONSTRAINT IF EXISTS pk_restaurant_commissions;
ALTER TABLE loyalty_transactions DROP CONSTRAINT IF EXISTS pk_loyalty_transactions;
ALTER TABLE loyalty_accounts DROP CONSTRAINT IF EXISTS pk_loyalty_accounts;
ALTER TABLE coupon_redemptions DROP CONSTRAINT IF EXISTS pk_coupon_redemptions;
ALTER TABLE invoices DROP CONSTRAINT IF EXISTS pk_invoices;
ALTER TABLE refunds DROP CONSTRAINT IF EXISTS pk_refunds;
ALTER TABLE delivery_locations DROP CONSTRAINT IF EXISTS pk_delivery_locations;
ALTER TABLE delivery_batch_orders DROP CONSTRAINT IF EXISTS pk_delivery_batch_orders;
ALTER TABLE delivery_batches DROP CONSTRAINT IF EXISTS pk_delivery_batches;
ALTER TABLE order_status_history DROP CONSTRAINT IF EXISTS pk_order_status_history;
ALTER TABLE cart_items DROP CONSTRAINT IF EXISTS pk_cart_items;
ALTER TABLE carts DROP CONSTRAINT IF EXISTS pk_carts;
ALTER TABLE restaurant_schedules DROP CONSTRAINT IF EXISTS pk_restaurant_schedules;
ALTER TABLE coupons DROP CONSTRAINT IF EXISTS pk_coupons;
ALTER TABLE complaints DROP CONSTRAINT IF EXISTS pk_complaints;
ALTER TABLE reviews DROP CONSTRAINT IF EXISTS pk_reviews;
ALTER TABLE payments DROP CONSTRAINT IF EXISTS pk_payments;
ALTER TABLE delivery_assignments DROP CONSTRAINT IF EXISTS pk_delivery_assignments;
...
ALTER TABLE restaurants DROP CONSTRAINT IF EXISTS pk_restaurants;
ALTER TABLE addresses DROP CONSTRAINT IF EXISTS pk_addresses;
ALTER TABLE users DROP CONSTRAINT IF EXISTS pk_users;
ALTER TABLE roles DROP CONSTRAINT IF EXISTS pk_roles;

-- ============================================================================
-- Add UUID columns and translate existing relationships.
-- ============================================================================

ALTER TABLE roles ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE users ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE addresses ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE restaurants ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE categories ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE products ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE orders ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE order_items ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE delivery_assignments ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE payments ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE reviews ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE complaints ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE coupons ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE restaurant_schedules ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE carts ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE cart_items ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE order_status_history ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE delivery_batches ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE delivery_batch_orders ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE delivery_locations ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE refunds ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE invoices ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE coupon_redemptions ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE loyalty_accounts ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE loyalty_transactions ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;
ALTER TABLE restaurant_commissions ADD COLUMN id_uuid UUID DEFAULT uuid_v7() NOT NULL;

ALTER TABLE users ADD COLUMN role_id_uuid UUID;
UPDATE users c SET role_id_uuid = p.id_uuid FROM roles p WHERE c.role_id = p.id;

ALTER TABLE addresses ADD COLUMN user_id_uuid UUID;
UPDATE addresses c SET user_id_uuid = p.id_uuid FROM users p WHERE c.user_id = p.id;

ALTER TABLE restaurants ADD COLUMN owner_user_id_uuid UUID;
UPDATE restaurants c SET owner_user_id_uuid = p.id_uuid FROM users p WHERE c.owner_user_id = p.id;

ALTER TABLE categories ADD COLUMN restaurant_id_uuid UUID;
UPDATE categories c SET restaurant_id_uuid = p.id_uuid FROM restaurants p WHERE c.restaurant_id = p.id;

ALTER TABLE products ADD COLUMN restaurant_id_uuid UUID;
ALTER TABLE products ADD COLUMN category_id_uuid UUID;
UPDATE products c SET restaurant_id_uuid = p.id_uuid FROM restaurants p WHERE c.restaurant_id = p.id;
UPDATE products c SET category_id_uuid = p.id_uuid FROM categories p WHERE c.category_id = p.id;
...
ALTER TABLE orders ADD COLUMN coupon_id_uuid UUID;
UPDATE orders c SET customer_user_id_uuid = p.id_uuid FROM users p WHERE c.customer_user_id = p.id;
UPDATE orders c SET restaurant_id_uuid = p.id_uuid FROM restaurants p WHERE c.restaurant_id = p.id;
UPDATE orders c SET delivery_address_id_uuid = p.id_uuid FROM addresses p WHERE c.delivery_address_id = p.id;
UPDATE orders c SET coupon_id_uuid = p.id_uuid FROM coupons p WHERE c.coupon_id = p.id;

ALTER TABLE order_items ADD COLUMN order_id_uuid UUID;
ALTER TABLE order_items ADD COLUMN product_id_uuid UUID;
UPDATE order_items c SET order_id_uuid = p.id_uuid FROM orders p WHERE c.order_id = p.id;
UPDATE order_items c SET product_id_uuid = p.id_uuid FROM products p WHERE c.product_id = p.id;
...
UPDATE delivery_assignments c SET order_id_uuid = p.id_uuid FROM orders p WHERE c.order_id = p.id;
UPDATE delivery_assignments c SET delivery_user_id_uuid = p.id_uuid FROM users p WHERE c.delivery_user_id = p.id;

ALTER TABLE payments ADD COLUMN order_id_uuid UUID;
UPDATE payments c SET order_id_uuid = p.id_uuid FROM orders p WHERE c.order_id = p.id;
...
UPDATE reviews c SET order_id_uuid = p.id_uuid FROM orders p WHERE c.order_id = p.id;
UPDATE reviews c SET reviewer_user_id_uuid = p.id_uuid FROM users p WHERE c.reviewer_user_id = p.id;
UPDATE reviews c SET restaurant_id_uuid = p.id_uuid FROM restaurants p WHERE c.restaurant_id = p.id;
UPDATE reviews c SET delivery_user_id_uuid = p.id_uuid FROM users p WHERE c.delivery_user_id = p.id;
...
UPDATE complaints c SET order_id_uuid = p.id_uuid FROM orders p WHERE c.order_id = p.id;
UPDATE complaints c SET customer_user_id_uuid = p.id_uuid FROM users p WHERE c.customer_user_id = p.id;
UPDATE complaints c SET assigned_admin_user_id_uuid = p.id_uuid FROM users p WHERE c.assigned_admin_user_id = p.id;

ALTER TABLE restaurant_schedules ADD COLUMN restaurant_id_uuid UUID;
UPDATE restaurant_schedules c SET restaurant_id_uuid = p.id_uuid FROM restaurants p WHERE c.restaurant_id = p.id;

ALTER TABLE carts ADD COLUMN customer_user_id_uuid UUID;
ALTER TABLE carts ADD COLUMN restaurant_id_uuid UUID;
UPDATE carts c SET customer_user_id_uuid = p.id_uuid FROM users p WHERE c.customer_user_id = p.id;
UPDATE carts c SET restaurant_id_uuid = p.id_uuid FROM restaurants p WHERE c.restaurant_id = p.id;

ALTER TABLE cart_items ADD COLUMN cart_id_uuid UUID;
ALTER TABLE cart_items ADD COLUMN product_id_uuid UUID;
UPDATE cart_items c SET cart_id_uuid = p.id_uuid FROM carts p WHERE c.cart_id = p.id;
UPDATE cart_items c SET product_id_uuid = p.id_uuid FROM products p WHERE c.product_id = p.id;
...
UPDATE order_status_history c SET order_id_uuid = p.id_uuid FROM orders p WHERE c.order_id = p.id;
UPDATE order_status_history c SET changed_by_user_id_uuid = p.id_uuid FROM users p WHERE c.changed_by_user_id = p.id;

ALTER TABLE delivery_batches ADD COLUMN delivery_user_id_uuid UUID;
UPDATE delivery_batches c SET delivery_user_id_uuid = p.id_uuid FROM users p WHERE c.delivery_user_id = p.id;
...
UPDATE delivery_batch_orders c SET delivery_batch_id_uuid = p.id_uuid FROM delivery_batches p WHERE c.delivery_batch_id = p.id;
UPDATE delivery_batch_orders c SET order_id_uuid = p.id_uuid FROM orders p WHERE c.order_id = p.id;
...
UPDATE delivery_locations c SET delivery_user_id_uuid = p.id_uuid FROM users p WHERE c.delivery_user_id = p.id;
UPDATE delivery_locations c SET order_id_uuid = p.id_uuid FROM orders p WHERE c.order_id = p.id;
UPDATE delivery_locations c SET delivery_batch_id_uuid = p.id_uuid FROM delivery_batches p WHERE c.delivery_batch_id = p.id;

ALTER TABLE refunds ADD COLUMN payment_id_uuid UUID;
ALTER TABLE refunds ADD COLUMN complaint_id_uuid UUID;
UPDATE refunds c SET payment_id_uuid = p.id_uuid FROM payments p WHERE c.payment_id = p.id;
UPDATE refunds c SET complaint_id_uuid = p.id_uuid FROM complaints p WHERE c.complaint_id = p.id;

ALTER TABLE invoices ADD COLUMN order_id_uuid UUID;
ALTER TABLE invoices ADD COLUMN payment_id_uuid UUID;
UPDATE invoices c SET order_id_uuid = p.id_uuid FROM orders p WHERE c.order_id = p.id;
UPDATE invoices c SET payment_id_uuid = p.id_uuid FROM payments p WHERE c.payment_id = p.id;

ALTER TABLE coupon_redemptions ADD COLUMN coupon_id_uuid UUID;
...
UPDATE coupon_redemptions c SET coupon_id_uuid = p.id_uuid FROM coupons p WHERE c.coupon_id = p.id;
UPDATE coupon_redemptions c SET order_id_uuid = p.id_uuid FROM orders p WHERE c.order_id = p.id;
UPDATE coupon_redemptions c SET customer_user_id_uuid = p.id_uuid FROM users p WHERE c.customer_user_id = p.id;

ALTER TABLE loyalty_accounts ADD COLUMN customer_user_id_uuid UUID;
UPDATE loyalty_accounts c SET customer_user_id_uuid = p.id_uuid FROM users p WHERE c.customer_user_id = p.id;
...
UPDATE loyalty_transactions c SET loyalty_account_id_uuid = p.id_uuid FROM loyalty_accounts p WHERE c.loyalty_account_id = p.id;
UPDATE loyalty_transactions c SET order_id_uuid = p.id_uuid FROM orders p WHERE c.order_id = p.id;

ALTER TABLE restaurant_commissions ADD COLUMN restaurant_id_uuid UUID;
UPDATE restaurant_commissions c SET restaurant_id_uuid = p.id_uuid FROM restaurants p WHERE c.restaurant_id = p.id;

-- ============================================================================
-- Replace numeric columns with UUID columns.
-- ============================================================================
...
ALTER TABLE orders RENAME COLUMN coupon_id_uuid TO coupon_id;
...
ALTER TABLE coupons RENAME COLUMN id_uuid TO id;

ALTER TABLE restaurant_schedules DROP COLUMN restaurant_id;
ALTER TABLE restaurant_schedules DROP COLUMN id;
ALTER TABLE restaurant_schedules RENAME COLUMN restaurant_id_uuid TO restaurant_id;
ALTER TABLE restaurant_schedules RENAME COLUMN id_uuid TO id;
...
ALTER TABLE coupon_redemptions DROP COLUMN coupon_id;
...
ALTER TABLE coupon_redemptions RENAME COLUMN coupon_id_uuid TO coupon_id;
...
ALTER TABLE restaurant_commissions DROP COLUMN id;
ALTER TABLE restaurant_commissions RENAME COLUMN restaurant_id_uuid TO restaurant_id;
ALTER TABLE restaurant_commissions RENAME COLUMN id_uuid TO id;

ALTER TABLE roles DROP COLUMN id;
ALTER TABLE roles RENAME COLUMN id_uuid TO id;

-- ============================================================================
-- Defaults, not-null constraints, primary keys, unique constraints and FKs.
-- ============================================================================

ALTER TABLE roles ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE users ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE addresses ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE restaurants ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE categories ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE products ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE orders ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE order_items ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE delivery_assignments ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE payments ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE reviews ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE complaints ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE coupons ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE restaurant_schedules ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE carts ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE cart_items ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE order_status_history ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE delivery_batches ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE delivery_batch_orders ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE delivery_locations ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE refunds ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE invoices ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE coupon_redemptions ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE loyalty_accounts ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE loyalty_transactions ALTER COLUMN id SET DEFAULT uuid_v7();
ALTER TABLE restaurant_commissions ALTER COLUMN id SET DEFAULT uuid_v7();
...
ALTER TABLE orders ALTER COLUMN customer_user_id SET NOT NULL;
...
ALTER TABLE delivery_assignments ALTER COLUMN order_id SET NOT NULL;
ALTER TABLE delivery_assignments ALTER COLUMN delivery_user_id SET NOT NULL;
...
ALTER TABLE complaints ALTER COLUMN order_id SET NOT NULL;
ALTER TABLE complaints ALTER COLUMN customer_user_id SET NOT NULL;
ALTER TABLE restaurant_schedules ALTER COLUMN restaurant_id SET NOT NULL;
ALTER TABLE carts ALTER COLUMN customer_user_id SET NOT NULL;
...
ALTER TABLE delivery_batches ALTER COLUMN delivery_user_id SET NOT NULL;
ALTER TABLE delivery_batch_orders ALTER COLUMN delivery_batch_id SET NOT NULL;
ALTER TABLE delivery_batch_orders ALTER COLUMN order_id SET NOT NULL;
ALTER TABLE delivery_locations ALTER COLUMN delivery_user_id SET NOT NULL;
ALTER TABLE refunds ALTER COLUMN payment_id SET NOT NULL;
ALTER TABLE invoices ALTER COLUMN order_id SET NOT NULL;
ALTER TABLE coupon_redemptions ALTER COLUMN coupon_id SET NOT NULL;
ALTER TABLE coupon_redemptions ALTER COLUMN order_id SET NOT NULL;
ALTER TABLE coupon_redemptions ALTER COLUMN customer_user_id SET NOT NULL;
ALTER TABLE loyalty_accounts ALTER COLUMN customer_user_id SET NOT NULL;
ALTER TABLE loyalty_transactions ALTER COLUMN loyalty_account_id SET NOT NULL;
ALTER TABLE restaurant_commissions ALTER COLUMN restaurant_id SET NOT NULL;
...
ALTER TABLE orders ADD CONSTRAINT fk_orders_coupon_id_coupons FOREIGN KEY (coupon_id) REFERENCES coupons (id);
...
ALTER TABLE coupon_redemptions ADD CONSTRAINT fk_coupon_redemptions_coupon_id_coupons FOREIGN KEY (coupon_id) REFERENCES coupons (id);
...
-- ============================================================================
-- Recreate indexes using UUID identifiers.
-- ============================================================================
