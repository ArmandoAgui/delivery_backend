...
import sv.edu.uca.delivery.backend.complaint.exception.ComplaintUnauthorizedException;
    ...
    public UUID getCurrentUserId() {
        ...
        try {
            ...
            return userRepository.findByEmail(identity)
                    .orElseThrow(() -> new ComplaintUnauthorizedException("Authenticated user does not exist"))
                    .getId();
        }
    }
